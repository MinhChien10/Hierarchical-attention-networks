...
'''
Định nghĩa cách mô hình HierAttNet khởi tạo trọng số và thực hiện quá trình lan truyền thuận.
Kết quả là một mô hình có khả năng học cách chú ý đến các từ và câu quan trọng trong một đoạn văn bản khi thực hiện các tác vụ phân loại văn bản.
'''
